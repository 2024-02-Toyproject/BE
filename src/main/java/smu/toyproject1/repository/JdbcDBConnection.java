...
public class JdbcDBConnection {
    ...
    public static List<CreditLoanProduct> retrieveCLDataFromTable(String tableName) {
        Connection connection = null;
    ...
    public static List<FixedDepositProduct> retrieveFDDataFromTable(String tableName) {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
